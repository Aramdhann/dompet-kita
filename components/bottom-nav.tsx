...
const menuItems = [
  {
    ...
    href: '/transaksi/tambah?type=income',
    color: 'text-emerald-600',
  },
  {
    label: 'Tambah Pengeluaran',
    icon: ArrowUpCircle,
    href: '/transaksi/tambah?type=expense',
    color: 'text-red-500',
  },
  {
...
export function BottomNav() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-20 left-1/2 -translate-x-1/2 w-full max-w-3xl z-40 pointer-events-none px-5">
        <div className="relative w-full h-0">
          <div className="absolute right-0 bottom-0 flex flex-col items-end gap-2 pointer-events-none">
            {/* Menu items */}
            <div
            ...
            <button
              ...
              className="w-14 h-14 rounded-full bg-blue-600 flex items-center justify-center active:scale-90 transition-all duration-200 pointer-events-auto"
              style={{
                boxShadow: isOpen
      ...
      {/* Bottom bar */}
      <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-3xl z-40 bg-white border-t border-gray-100 shadow-lg">
